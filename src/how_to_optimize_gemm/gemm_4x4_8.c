...
static void add_dot_4x4(int k, float *a, int lda, float *b, int ldb, float *c,
  ...
  for (int s = 0; s < k; s++) {
    ...
    tmp_00 += tmp_a * tmp_b_0;
    tmp_01 += tmp_a * tmp_b_1;
    tmp_02 += tmp_a * tmp_b_2;
    tmp_03 += tmp_a * tmp_b_3;

    tmp_a = A(1, s);
    tmp_10 += tmp_a * tmp_b_0;
    tmp_11 += tmp_a * tmp_b_1;
    tmp_12 += tmp_a * tmp_b_2;
    tmp_13 += tmp_a * tmp_b_3;

    tmp_a = A(2, s);
    tmp_20 += tmp_a * tmp_b_0;
    tmp_21 += tmp_a * tmp_b_1;
    tmp_22 += tmp_a * tmp_b_2;
    tmp_23 += tmp_a * tmp_b_3;

    tmp_a = A(3, s);
    tmp_30 += tmp_a * tmp_b_0;
    tmp_31 += tmp_a * tmp_b_1;
    tmp_32 += tmp_a * tmp_b_2;
    tmp_33 += tmp_a * tmp_b_3;
  }
